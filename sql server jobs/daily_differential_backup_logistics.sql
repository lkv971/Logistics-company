...
/****** Object:  Job [daily_differential_backup_logistics]    Script Date: 8/8/2024 10:05:23 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 8/8/2024 10:05:23 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Differential backup]    Script Date: 8/8/2024 10:05:23 AM ******/
...
SET @differential_backup_path = ''C:\Users\ACER\Documents\GitHub\Logistics\backups\Differentia\Logistics_differential_'' + FORMAT(GETDATE(), ''yyyymmdd'') + ''.bak''

BACKUP DATABASE LogisticsDB
TO DISK @differential_backup_path
WITH DIFFERENTIAL
;
GO', 
